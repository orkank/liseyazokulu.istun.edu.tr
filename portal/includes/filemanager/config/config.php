...
$config = array(
    ...
    */
    ...
    |
    */
    'upload_dir' => $sl->settings['upload']. 'data/' .date('Y-m-d'). '/',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'current_path' => '../../..'.$sl->settings['upload']. 'data/' .date('Y-m-d'). '/',
    ...
    |
    */
    'thumbs_base_path' => '../../..'.$sl->settings['upload']. 'data/' .date('Y-m-d'). '/thumbs/',
    ...
    |
    */
    'thumbs_upload_dir' => $sl->settings['upload']. 'data/' .date('Y-m-d'). '/thumbs/',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'default_language' => $sl->languages('prefix'),
    ...
    */
    ...
    //*********************
    'ext_blacklist'							  => ['exe','bat','php','cgi','py'],
