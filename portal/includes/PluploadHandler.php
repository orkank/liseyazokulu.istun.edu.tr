    ...
    function __construct($conf = array())
    {
        $this->conf = array_merge(
            array(
                ...
                'error_strings' => array(
                    PLUPLOAD_MOVE_ERR => "Dosya taşıma hatası.",
                    PLUPLOAD_INPUT_ERR => "Yükleme başlatılamadı.",
                    PLUPLOAD_OUTPUT_ERR => "Çıktı akışı açılırken hata oluştu.",
                    PLUPLOAD_TMPDIR_ERR => "Yükleme dizini açılamadı.",
                    PLUPLOAD_TYPE_ERR => "Dosya türüne izin verilmiyor.",
                    PLUPLOAD_UNKNOWN_ERR => "Bilinmeyen bir hata oluştu.",
                    PLUPLOAD_SECURITY_ERR => "Dosya güvenlik taramasını geçemedi."
                ),
                'debug' => false,
                'log_path' => "error.log"
            ),
